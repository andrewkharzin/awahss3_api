...
// const GRAPHQL_ENDPOINT = 'http://127.0.0.1:8000/graphql'; // Replace with your GraphQL API endpoint

// export const getAirlineLogoByIATA = async (iata: string) => {
...
//     const airlineNode = response.airlines.edges[0]?.node;
//     if (airlineNode && airlineNode.arlLogo) {
//       return airlineNode;
//     } else {
//       return null;
//     }
//   } catch (error) {
//     console.log('Error fetching airline logo:', error);
//     return null;
//   }
// };

const API_KEY = "7c8a729991b6fefbfd9e89863279c947"; // Замените на ваш ключ API
