    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('callsign', models.CharField(blank=True, default='', max_length=155, null=True, verbose_name='Callsign')),
                ('codeHub', models.CharField(blank=True, default='', max_length=5, null=True, verbose_name='CodeHUB')),
                ('codeIso2Country', models.CharField(blank=True, default='', max_length=4, verbose_name='CodeIso2Country')),
                ('codeIataAirline', models.CharField(blank=True, default='', max_length=3, null=True, verbose_name='Iata')),
                ('codeIcaoAirline', models.CharField(blank=True, default='', max_length=4, null=True, verbose_name='Icao')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registrationNumber', models.CharField(blank=True, max_length=20, null=True)),
                ('acCode', models.CharField(blank=True, max_length=4, null=True)),
