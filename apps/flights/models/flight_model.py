...
class CharterFlight(models.Model):
    ...
    state_status = models.CharField(
        max_length=20, choices=STATE_STATUS_CHOICES, default='New')
    hand_status = models.CharField(
        max_length=20, choices=RAMP_HANDLING_STATUS_CHOICES, default='New')
    trip_status = models.CharField(
        max_length=20, choices=TRIP_STATUS_CHOICES, default='Opened')
